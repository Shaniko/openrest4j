...
public class CurbsideInfo implements Serializable, Cloneable {
    ...
    public CurbsideInfo(String instructions, Boolean withAdditionalInformation, String additionalInformation) {
        this.instructions = instructions;
        this.additionalInformationRequired = (withAdditionalInformation != null) ? withAdditionalInformation : false;
